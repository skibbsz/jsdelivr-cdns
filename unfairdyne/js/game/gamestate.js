...
function GameState() {
  ...
  hp_text = new PIXI.extras.BitmapText("04 / 04", {
    font: "15px Numbers",
    align: "right"
  });
  ...
  time_text = new PIXI.extras.BitmapText("00:00.00", {
    font: "15px Numbers",
    align: "left"
  });
  ...
  love_text = new PIXI.extras.BitmapText("LV " + this.level, {
    font: "15px Numbers",
    align: "left"
  });

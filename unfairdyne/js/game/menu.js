...
function Menu() {
  ...
  this.select_text = new PIXI.extras.BitmapText("Select a difficulty level.", {
    font: "18px Undertale"
  });
  this.select_text.position.set(80, 260);
  this.select_text.visible = false;

  this.normal_text = new PIXI.extras.BitmapText("", {
    font: "18px Undertale"
  });
  this.normal_text.position.set(80, 300);
  this.normal_text_chars = 0;
  this.hard_text = new PIXI.extras.BitmapText("", {
    font: "18px Undertale"
  });
  this.hard_text.position.set(80, 332);
  this.hard_text_chars = 0;
  this.genocide_text = new PIXI.extras.BitmapText("", {
    font: "18px Undertale"
  });
